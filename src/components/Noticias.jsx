...
const Noticias = () => {
  return (
    <section className="relative mt-16 md:mt-32 min-h-[800px] px-4 md:px-8 lg:px-12">
      ...
      <div className="flex justify-center flex-wrap lg:flex-nowrap mt-10 gap-6">
        {/* Artigo 1 */}
        <article className="w-full sm:w-1/2 lg:w-1/4 p-4 flex flex-col justify-between">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 text-center">
            ...
            <div className="mt-auto flex flex-col items-center space-y-2">
              <a
                ...
                className="flex items-center text-lg font-bold overpass py-2 px-4 text-[#127aba] rounded-full hover:bg-[#239ddb] hover:text-white transition duration-300">
                LEIA MAIS <MoveRight className="ml-2" />
              </a>
            </div>
          </div>
        </article>
