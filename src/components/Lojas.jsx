    ...
    return (
      <section className="relative mt-16 md:mt-32 min-h-[800px] px-4 md:px-8 lg:px-12">
        <header className="text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold bg-gradient-to-b from-[#32A0E4] to-[#0870AFCC] text-transparent bg-clip-text my-8 tracking-wide">
        ...
        <div className="flex flex-wrap lg:flex-nowrap mt-10 gap-6 justify-center">
          {/* Loja 1 - Santo André */}
          <article className="w-full sm:w-1/2 lg:w-1/4 p-4 flex flex-col">
            <div className="shadow-lg rounded-lg overflow-hidden border border-gray-200 flex-grow">
              <img
                src="src/assets/Ouviden-Unidade-SantoAndre.jpg"
                alt="Ouviden no ABC, Santo André / SP"
                className="w-full h-48 sm:h-56 lg:h-64 object-cover"
              />
              <div className="p-4 sm:p-5 lg:p-6">
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 text-center">Ouviden no ABC, Santo André</h2>
                <address className="not-italic mb-4 font-medium text-sm sm:text-base lg:text-lg text-center">
                ...
                <div className="flex flex-col items-center space-y-2">
                  <a
                    ...
                    className="flex items-center text-sm sm:text-base lg:text-lg font-medium py-2 px-4 rounded-lg hover:bg-[#D6A000] hover:text-white transition duration-300">
                    <Map className="mr-2 text-xl sm:text-2xl" /> Localização
                  </a>
                  <a
                    href="tel:+551144364256"
                    title="Ligar para a Ouviden no ABC, Santo André"
                    className="flex items-center text-sm sm:text-base lg:text-lg font-medium py-2 px-4 rounded-lg hover:bg-[#0870AFCC] hover:text-white transition duration-300">
                    <Phone className="mr-2 text-xl sm:text-2xl" /> Ligar (11) 4436-4256
                  </a>
                  <a
                    href="https://wa.me/5511945185253"
                    title="Conversar via WhatsApp com a Ouviden no ABC, Santo André"
                    className="flex items-center text-sm sm:text-base lg:text-lg font-medium py-2 px-4 rounded-lg hover:bg-green-700 hover:text-white transition duration-300">
                    <FaWhatsapp className="mr-2 text-xl sm:text-2xl" /> Falar no WhatsApp
                  </a>
                </div>
              </div>
            </div>
          ...
          <article className="w-full sm:w-1/2 lg:w-1/4 p-4 flex flex-col">
            <div className="shadow-lg rounded-lg overflow-hidden border border-gray-200 flex-grow">
              <img
                src="src/assets/Ouviden-Unidade-Atibaia.jpg"
                alt="Ouviden em Atibaia, São Paulo"
                className="w-full h-48 sm:h-56 lg:h-64 object-cover"
              />
              <div className="p-4 sm:p-5 lg:p-6">
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 text-center">Ouviden em Atibaia, São Paulo</h2>
                <address className="not-italic mb-4 font-medium text-sm sm:text-base lg:text-lg text-center">
                ...
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <a
                    ...
                    className="flex items-center text-sm sm:text-base lg:text-lg font-medium py-2 px-4 rounded-lg hover:bg-[#0870AFCC] hover:text-white transition duration-300">
                    <Phone className="mr-2 text-xl sm:text-2xl" /> Ligar (11) 2427-1623
                  </a>
                  <a
                    href="https://wa.me/5511945185253"
          ...
          <article className="w-full sm:w-1/2 lg:w-1/4 p-4 flex flex-col">
            <div className="shadow-lg rounded-lg overflow-hidden border border-gray-200 flex-grow">
              <img
                src="src/assets/Ouviden-Unidade-Moema-Fachada.jpg"
                alt="Ouviden em Moema, São Paulo"
                className="w-full h-48 sm:h-56 lg:h-64 object-cover"
              />
              <div className="p-4 sm:p-5 lg:p-6">
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 text-center">Ouviden em Moema, São Paulo</h2>
                <address className="not-italic mb-4 font-medium text-sm sm:text-base lg:text-lg text-center">
                ...
                <div className="flex flex-grow flex-col items-center space-y-2">
                  ...
                  <a
                    ...
                    className="flex items-center text-sm sm:text-base lg:text-lg font-medium py-2 px-4 rounded-lg hover:bg-[#0870AFCC] hover:text-white transition duration-300">
                    <Phone className="mr-2 text-xl sm:text-2xl" /> Ligar (11) 2894-4202
                  </a>
                  <a
                    href="https://wa.me/#"
