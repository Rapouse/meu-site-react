const BannerSection = () => {
  return (
    <section
      className="relative bg-[url('src/assets/Ouviden-Espaco-Relaxante-e-Confortavel-em-Moema.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center min-h-screen md:min-h-[500px] lg:min-h-[600px]"
      role="banner"
