      ...
      <div className="relative z-10 text-white text-center flex flex-col items-center px-4 py-16 sm:py-24 md:py-28 lg:py-32">
        ...
        <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
          <a
            ...
            className="px-6 sm:px-8 md:px-10 lg:px-12 py-3 text-base sm:text-lg md:text-xl lg:text-2xl font-semibold bg-white text-[#127aba] rounded-full shadow-lg hover:bg-[#f1f1f1] hover:opacity-90 transition-all duration-300"
          ...
          <a
            ...
            className="px-6 sm:px-8 md:px-10 lg:px-12 py-3 text-base sm:text-lg md:text-xl lg:text-2xl font-semibold bg-[#D6A000] text-white rounded-full shadow-lg hover:bg-[#c59a00] hover:opacity-90 transition-all duration-300"
